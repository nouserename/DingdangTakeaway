    ...
    <div>
        <section v-if="!showLoading" class="shop_container">
            ...
            <section class="change_show_type" ref="chooseType">
                ...
                <svg width="4rem" height="100%" xmlns="http://www.w3.org/2000/svg" version="1.1" style="margin-top:0.5rem;">
                    <polyline points="12,18 4,9 12,0" style="fill:none;stroke:rgb(0,0,255);stroke-width:3"/>
                </svg>
            </nav>
                <div>
            ...
            <transition name="fade-choose">
                <section v-show="changeShowType =='food'" class="food_container">
                    <section class="menu_container">
                        ...
                        <section class="menu_right" ref="menuFoodList" @click="setScroll()">
                            <ul>
                    ...
                    <transition name="toggle-cart">
                        <section class="cart_food_list" v-show="showCartList&&cartFoodList.length">
                            ...
                            <section class="cart_food_details" id="cartFood">
                                <ul>
                                    <li v-for="(item, index) in cartFoodList" :key="index" class="cart_food_li" @click="setScroll()">
            ...
            <transition name="fade-choose">
                <section class="rating_container" id="ratingContainer" v-show="changeShowType =='rating'">
                    <h4 style="textAlign:center;marginTop:5rem;">没有任何评价</h4>
                </section>
            </transition>
        </section>
        <section>
