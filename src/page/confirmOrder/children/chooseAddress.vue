    ...
    <div class="rating_page">
        ...
        <section id="scroll_section" class="scroll_container">
            <section class="list_cotainer">
                ...
                <!-- chooseAddress 绑定方法，监听选择的那个地址 -->
                    <li v-for="(item,index) in deliverable" @click.prevent.stop="chooseAddress(item, index)" :key="item.name">
                ...
                <section id="out_delivery" v-if="deliverdisable.length">
                    ...
                    <ul class="deliverable_address">
                        <li v-for="(item,index) in deliverdisable" :key="item.phone+index">
